...
def _trace(connection, question) -> dict:
        ...
        stages.append(
            {
                ...
                "selection_version": terminal["selection_version"],
                "sample_phase": terminal["sample_phase"],
    ...
    return {
        ...
        "runtime_selection": {
            ...
            "model_profile_id": question["model_profile_id"],
            "requested_model_id": question["requested_model_id"],
            "model_config_ref": question["model_config_ref"],
            "provider": question["model_provider"],
            "selection_version": question["selection_version"],
            "selected_at": question["selection_selected_at"],
            "sample_phase": question["sample_phase"],
            "resolved_model_id": question["resolved_model_id"],
            "resolved_provider": question["resolved_provider"],
        },
        "complete": complete,
