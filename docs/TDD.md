...
- `src/sidestage/app.py`: FastAPI application factory, opaque demo-session issuance and restoration, server-owned snapshots, five action endpoints, conditional compensation, prepared/custom chat endpoints, developer reset endpoint, SSE, and debugger projections.
