...
> Status: `Accepted` — builder-approved v1 design; Milestone 2, deterministic M3B.1-M3B.4 behavior, and the M3B.5 Optimization and Debug Session are `Verified`; a follow-up latency optimization is `Implemented` but uncommitted, and the final live release gate is open
>
