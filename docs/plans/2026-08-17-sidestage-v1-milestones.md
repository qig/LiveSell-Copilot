...
2. Routing and scheduling:
   ...
   - Configure both static profiles for capacity 64/show, four workers/show, twelve global, and the propagated five-second timeout; a full queue preserves raw input and starts no registered-agent provider call. Only the baseline may already have completed its bounded analysis call.
...
2. Pressure contract:
   ...
   - Enforce four workers/show and twelve globally.
3. Golden demo:
